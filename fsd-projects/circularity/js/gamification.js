...
var Gamification = (function () {
  ...
  // Create player 1 (teal/blue variant, uses WASD)
  function createPlayer1() {
    player1 = draw.randomCircleInArea(canvas, true, true, "#00CED1", 3);
    player1.radius = 15;
    ...
    addPlayerTooltip(player1, "P1", "#00CED1");
  ...
  // Create player 2 (deep blue, uses arrow keys)
  function createPlayer2() {
    // Create player2 using the same method as player1 but with blue color
    player2 = draw.randomCircleInArea(canvas, true, true, "#0000FF", 3);
    player2.radius = 15;
    ...
    addPlayerTooltip(player2, "P2", "#0000FF");
